...
import com.marsad.BoToTravel.adapter.ViewPagerAdapter;
import com.marsad.BoToTravel.fragments.Search;
...
public class MainActivity extends AppCompatActivity implements Search.OnDataPass {
    ...
    private void addTabs() {
        ...
        drawableResList.add(R.drawable.img_booking);
        drawableResList.add(R.drawable.ic_event);
...
//                        tabLayout.getTabAt(0).setIcon(R.drawable.ic_home_fill);
                    ...
                    case 1:
                        tab.setIcon(R.drawable.img_booking);
                        break;
